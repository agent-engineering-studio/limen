...
Il raster lo scarica ``fetch.py`` dall'ImageServer pubblico dell'EEA, che
serve lo stesso prodotto senza account: ``limen imperviousness-fetch``.

Source: https://land.copernicus.eu/en/products/high-resolution-layer-imperviousness
"""

from limen.integrations.imperviousness.fetch import fetch_imperviousness
