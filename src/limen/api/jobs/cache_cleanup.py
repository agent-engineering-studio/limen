...
Hot-table partition maintenance and retention deliberately do **not** live
here: this job is skipped entirely under the pg_cron backend, and a missing
partition sends every write to ``*_default`` where retention cannot reach it.
They are their own always-registered job, :mod:`limen.api.jobs.partitions`.
"""
